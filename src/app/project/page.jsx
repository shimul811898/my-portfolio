  ...
  const projects = [
    {
      title: "MediCare",
      description:
        "A modern full-stack healthcare platform that enables patients to find doctors, book appointments, manage schedules, and access healthcare services through a secure, responsive, and user-friendly interface.",
      category: "FULLSTACK",
      tags: [
        "Next.js",
        "Express.js",
      ...
      liveUrl: "https://medi-care-mocha.vercel.app",
      githubUrlClint: "https://github.com/shimul811898/MediCare",
      githubUrlServer:"https://github.com/shimul811898/MediCare-Sever",
      image: "/assest/Medicare.png",
      isEmbedImage: true,
    },
    {
      ...
      githubUrlClint: "https://github.com/shimul811898/DocAppoint",
      githubUrlServer:"https://github.com/shimul811898/DocAppoint-Server",
    ...
    },
    {
      ...
      githubUrlClint: "https://github.com/shimul811898/A8-SunCart",
    ...
    },
    {
      ...
      githubUrlClint: "https://github.com/shimul811898/ai-module-hub",
    ...
    },
    {
      ...
      githubUrlClint: "https://github.com/shimul811898/B-13-Assinment-no-6",
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className={`flex items-center gap-4 pt-4 border-t ${dark ? "border-white/5" : "border-slate-100"}`}>
                      ...
                      <a
                        href={project.githubUrlClint}
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`flex items-center gap-1.5 text-xs font-semibold tracking-wide uppercase transition-colors
                        ${dark ? "text-slate-400 hover:text-white" : "text-slate-500 hover:text-slate-800"}`}
                      >
                        <GithubIcon className="w-3.5 h-3.5" /><span className="text-[10px]" >Source Code (CLient Side)</span>
                      </a>
                      {project.githubUrlServer && (
                        <a
                          ...
                          ${dark ? "text-slate-400 hover:text-white" : "text-slate-500 hover:text-slate-800"}`}
                        >
                          <GithubIcon className="w-3.5 h-3.5" /> <span className="text-[10px]">Source Code (Server Side)</span>
                        </a>
                      )}
                    </div>
                  </div>
